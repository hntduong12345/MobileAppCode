...
import com.example.sqlite.Adapters.CongViecAdapter;
import com.example.sqlite.DatabaseConfig.Database;
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(tenCV)) {
                    Toast.makeText(MainActivity.this, "Vui lòng nhập lại tên công việc", Toast.LENGTH_SHORT).show();
                }else{
