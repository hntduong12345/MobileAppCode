        ...
        iv_Call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (!hasPermissions(OtherPermissionActivity.this, PERMISSIONS)) {
                        ActivityCompat.requestPermissions((Activity) OtherPermissionActivity.this, PERMISSIONS, 112 );
                    } else {
                        makeCall();
                    }
                } else {
        ...
        switch (requestCode) {
            case 112: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(OtherPermissionActivity.this, "The app was not allowed to call.", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
